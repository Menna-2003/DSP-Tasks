...
from Task1 import add_signals, subtract_signals, multiply_signal, shifting_signal, fold_signal
import numpy as np
...
sig1, sig2 = ReadSignalFile("Signal1.txt"), ReadSignalFile("Signal2.txt")
sig1_idx = np.asarray(sig1[0], dtype=int)
sig1_val = np.asarray(sig1[1], dtype=float)
sig2_idx = np.asarray(sig2[0], dtype=int)
sig2_val = np.asarray(sig2[1], dtype=float)
indicies, samples = add_signals([(sig1_idx, sig1_val), (sig2_idx, sig2_val)])
...
sig2_idx = np.asarray(sig2[0], dtype=int)
sig2_val = np.asarray(sig2[1], dtype=float)
indicies, samples = subtract_signals((sig1_idx, sig1_val), (sig2_idx, sig2_val))
...
sig1 = ReadSignalFile("Signal1.txt")
sig1_idx = np.asarray(sig1[0], dtype=int)
sig1_val = np.asarray(sig1[1], dtype=float)
indicies, samples = multiply_signal(sig1_idx, sig1_val, 5)
...
sig1_idx = np.asarray(sig1[0], dtype=int)
sig1_val = np.asarray(sig1[1], dtype=float)
indicies, samples = shifting_signal(sig1_idx, sig1_val, 3, "advance")
...
sig1_idx = np.asarray(sig1[0], dtype=int)
sig1_val = np.asarray(sig1[1], dtype=float)
indicies, samples = fold_signal(sig1_idx, sig1_val)
