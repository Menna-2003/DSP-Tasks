def QuantizationTest1(file_name,Your_EncodedValues,Your_QuantizedValues):
    ...
    if( (len(Your_EncodedValues)!=len(expectedEncodedValues)) or (len(Your_QuantizedValues)!=len(expectedQuantizedValues))):
        ...
        return
    print("Encoded values : ", Your_EncodedValues)
    print("Ecxpexted        ", expectedEncodedValues)
    ...
    print("QuantizedValues: ", Your_QuantizedValues)
    print("Ecxpexted        ", expectedQuantizedValues)
